    ...
    it('returns all saved metadata-backed config fields enriched on GET', async () => {
      ...
      metadataRegistryClient.getValuesByTypes.mockResolvedValue({
        items: [
          ...
          { metadataType: 'Speciality', displayName: 'Speciality', multiSelectAllowed: true, valueDataType: 'string', values: [{ valueCode: 'SPEC_A', label: 'Speciality A', status: 'active', isGlobal: true, sortOrder: 1, attributes: {}, applicability: { module: [], category: [], condition: [], country: [], language: [] } }] },
