...
> **HTTP + JSON examples:** [`api-mappings.md`](api-mappings.md) · **Examples JSON:** [`option-b-dynamodb-mappings.examples.json`](option-b-dynamodb-mappings.examples.json) · **Requirements v2 delta:** [`requirements-v2-changes.md`](requirements-v2-changes.md) · **OpenAPI:** [`open-api.yaml`](../../open-api.yaml) · **Stories:** [`story-real-life-examples-1-15.md`](story-real-life-examples-1-15.md)
