...
import { validateCreateMonitoringActionRequest } from '../../validators/request.validators';

const c = getTaskHttpController();

const handler = async (req: LambdaRequest) => c.handleCreateMonitoringAction(req);
