...
// ../../node_modules/.pnpm/@aws-sdk+util-dynamodb@3.958.0_@aws-sdk+client-dynamodb@3.958.0/node_modules/@aws-sdk/util-dynamodb/dist-cjs/index.js
var require_dist_cjs = __commonJS({
  "../../node_modules/.pnpm/@aws-sdk+util-dynamodb@3.958.0_@aws-sdk+client-dynamodb@3.958.0/node_modules/@aws-sdk/util-dynamodb/dist-cjs/index.js"(exports2) {
    "use strict";
...
// src/handlers/stream/userProfileStreamHandler.handler.ts
var userProfileStreamHandler_handler_exports = {};
__export(userProfileStreamHandler_handler_exports, {
  main: () => main
});
module.exports = __toCommonJS(userProfileStreamHandler_handler_exports);
...
async function userProfileStreamHandler(event) {
  ...
  const processedSequenceNumbers = /* @__PURE__ */ new Set();
  for (const record of event.Records) {
    ...
    try {
      ...
      if (eventName === "INSERT" && record.dynamodb?.NewImage) {
        item = (0, import_util_dynamodb.unmarshall)(record.dynamodb.NewImage);
...
*/
//# sourceMappingURL=userProfileStreamHandler.handler.js.map
