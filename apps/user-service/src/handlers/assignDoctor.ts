...
interface Body {
  ...
  sender: { userId: string; name?: string; email?: string; userType?: string; presenceStatus?: string };
  receiver: { userId: string; name?: string; email?: string; profileImage?: string; userType?: string; presenceStatus?: string };
  isReferred?: boolean;
}
