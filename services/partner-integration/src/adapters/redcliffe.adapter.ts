...
const REDCLIFFE_SECRET_ARN_KEY = 'REDCLIFFE_API_KEY_SECRET_ARN';
const REDCLIFFE_API_KEY_ENV = 'REDCLIFFE_API_KEY';
...
export class RedcliffeAdapter implements LabPartnerAdapter {
  ...
  private async getAuthHeaders(): Promise<Record<string, string>> {
    ...
    const apiKey = await getPartnerApiKey(REDCLIFFE_SECRET_ARN_KEY, REDCLIFFE_API_KEY_ENV);
    return {
