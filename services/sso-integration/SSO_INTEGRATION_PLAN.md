...
- Patients can be many (bulk processing needed)
- Don't want to block user login waiting for all patients
- Patients can be created/updated later if needed
...
| - | `userInfo.medicalHistory` | Default: { allergies: [], chronicDiseases: [], symptoms: [] } |
